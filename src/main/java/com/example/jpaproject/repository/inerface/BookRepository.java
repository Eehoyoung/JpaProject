...
import com.example.jpaproject.repository.dto.BookNameAndCategory;
...
public interface BookRepository extends JpaRepository<Book, Long> {
    ...
    @Query(value = "select new com.example.jpaproject.repository.dto.BookNameAndCategory(b.name, b.category) from Book b")
